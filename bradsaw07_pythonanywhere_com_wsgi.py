...
# web application at http://Bradsaw07.pythonanywhere.com/
...
#import sys
#
#path = '/home/Bradsaw07/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/Bradsaw07/mysite/mysite/settings.py'
## and your manage.py is is at '/home/Bradsaw07/mysite/manage.py'
#path = '/home/Bradsaw07/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/Bradsaw07" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/Bradsaw07/myproject"
path = '/home/Bradsaw07/taller_despliegue_directo'
if path not in sys.path:
    sys.path.append(path)
#
